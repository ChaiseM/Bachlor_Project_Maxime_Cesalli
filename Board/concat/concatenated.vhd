...
ENTITY testerRS232 IS
    ...
    PORT( 
        ...
        debug1     : OUT    std_ulogic_vector (3 DOWNTO 0)
    );
   ...
   begin 
      if reset = '1' then
         ...
         if RS232Valid = '1' then 
            -- Idle State 
            if currentState = state_idle and isX = '1' then 
               debug10 <= not debug10;
            ...
            if currentState = state_Test1 and isExcla = '1' then 
               --debug11 <= not debug11;
            ...
            if currentState = state_newCoeff then 
               ...
               elsif isExcla = '1'  then currentState <= state_idle;
               end if;
...
ARCHITECTURE visitorsVersion OF leftRightSplitter IS
    ...
    SIGNAL debug0      : std_ulogic;
    SIGNAL debug1      : std_ulogic_vector(3 DOWNTO 0);
