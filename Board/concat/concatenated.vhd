...
-- VHDL Entity Splitter.HighPass.symbol
--
-- Created:
--          by - maxime.cesalli.UNKNOWN (WE2330804)
--          at - 11:21:25 12.06.2023
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2019.2 (Build 5)
--
LIBRARY ieee;
...
BEGIN
    ...
    I2 : iisEncoder
        ...
        PORT MAP (
            reset      => reset,
            clock      => clock,
            audioLeft  => LowPassOut,
            audioRight => HighpassOut,
            LRCK       => LR_O,
            SCK        => CLK_O,
            DOUT       => Data_O,
            CLKI2s     => CLK_I,
