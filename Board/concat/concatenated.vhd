...
ENTITY Xover_with_RAM IS
    ...
    PORT( 
        ...
        filterTapNb  : IN     integer RANGE 15 DOWNTO 0;
...
ENTITY testerRS232 IS
    ...
    PORT( 
        ...
        clock       : IN     std_ulogic;
        reset       : IN     std_ulogic;
        FilterTapNb : OUT    integer RANGE 15 DOWNTO 0;
...
ARCHITECTURE visitorsVersion OF leftRightSplitter IS
    ...
    SIGNAL FilterTapNb : integer RANGE 15 DOWNTO 0;
...
ARCHITECTURE struct OF FPGA_splitter IS
    ...
    constant rs232BaudRate: real := 57.6E3;
