...
ENTITY FPGA_splitter IS
    ...
    PORT( 
        ...
        LR_O       : OUT    std_ulogic;
        Next_data  : OUT    std_uLogic;
        end_Calc   : OUT    std_uLogic
    );
...
ARCHITECTURE visitorsVersion OF leftRightSplitter IS
    ...
    SIGNAL Data_Valid_internal : std_ulogic;
    SIGNAL Next_data_internal  : std_ulogic;
    SIGNAL end_Calc_internal   : std_ulogic;
...
BEGIN
    ...
    I4 : SeialSync
        ...
        PORT MAP (
            DataReady   => end_Calc_internal,
            LR_I        => LR_I,
            NewData     => Next_data_internal,
            clock       => clock,
            highPass    => highPass,
            lowPass     => lowPass,
            reset       => reset,
    ...
    Next_data  <= Next_data_internal;
    end_Calc   <= end_Calc_internal;
