...
# Example usage 8: ./Scripts/deployScripts.bash -v -p isc-eln-labs -r https://github.com/hei-isc-eln/eln-labs.git
# Example usage 9: ./Scripts/deployScripts.bash -v -p eln-display -r https://github.com/hei-isc-eln/eln-display.git
#
