...
./deployScripts.bash -v -p isc-eln-labs -r https://github.com/hei-isc-eln/eln-labs.git
...
./deployScripts.bash -v -p eln-kart -r https://github.com/hei-synd-2131-eln/eln-kart.git
