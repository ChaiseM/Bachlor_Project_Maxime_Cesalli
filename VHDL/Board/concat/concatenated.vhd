...
ENTITY Xover_with_RAM IS
    ...
    PORT( 
        ...
        gainIn       : IN     integer RANGE 999 DOWNTO 0;
...
ENTITY testerRS232 IS
    ...
    PORT( 
        ...
        gainOut     : OUT    integer RANGE 999 DOWNTO 0;
...
-- VHDL Entity Splitter.LefrRightSelector.symbol
--
-- Created:
--          by - maxime.cesalli.UNKNOWN (WE2330804)
--          at - 13:36:18 15.08.2023
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2019.2 (Build 5)
--
LIBRARY ieee;
...
ENTITY LefrRightSelector IS
    GENERIC( 
        DATA_WIDTH : positive
    );
    PORT( 
        S21         : IN     std_ulogic;
        audio_L_out : IN     signed (DATA_WIDTH-1 DOWNTO 0);
        audio_R_out : IN     signed (DATA_WIDTH-1 DOWNTO 0);
        audio_In    : OUT    signed (DATA_WIDTH-1 DOWNTO 0)
    );

-- Declarations

END LefrRightSelector ;
...
ARCHITECTURE visitorsVersion OF leftRightSplitter IS
    ...
    SIGNAL audio_In    : signed(DATA_WIDTH-1 DOWNTO 0);
    ...
    FOR ALL : LefrRightSelector USE ENTITY Splitter.LefrRightSelector;
