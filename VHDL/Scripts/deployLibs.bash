...
# Example usage 8: ./Scripts/deployLibs.bash -v -p isc-eln-labs -r https://github.com/hei-isc-eln/eln-labs.git
# Example usage 9: ./Scripts/deployLibs.bash -v -p eln-display -r https://github.com/hei-isc-eln/eln-display.git
#
...
# [isc-eln-labs](https://github.com/hei-isc-eln/eln-labs.git)
# [ele_labs]()
...
# [eln-display](https://github.com/hei-isc-eln/eln-display.git)
# [eln_support]()
# [eptm_radio]()
# [eptm_audioamp]()
# [cansat]()
